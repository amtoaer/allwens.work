  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/other/gravatar.jpg')
      } else {
        ele.src = '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/other/default_gavatar.jpg'
      break
    case 3:

      ele.src = '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/other/image-404.png'
      break
    default:
      ele.src = '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/other/image-404.png'
  }
...
function checkBgImgCookie() {
  ...
  if (bgurl != '') {
    if (bgurl == '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/themebg/sakura.png' || bgurl == '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/themebg/plaid.jpg' || bgurl == '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/themebg/star.png' || bgurl == '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/themebg/point.png' || bgurl == '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#sakura-bg', '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/themebg/sakura.png')
  changeBG('#gribs-bg', '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/themebg/plaid.jpg')
  changeBG('#pixiv-bg', '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/themebg/star.png')
  changeBG('#KAdots-bg', '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/themebg/point.png')
  changeBG('#totem-bg', '//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/themebg/little-monster.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(//cdn.jsdelivr.net/gh/amtoaer/blogcdn@master/img/other/starry_sky.png)')
  ...
  Siren = {
    ...
    MJ: function () {
      if (mashiro_option.mathjax == '1') {
        $.getScript('//cdn.jsdelivr.net/npm/mathjax@2.7.4/MathJax.js?config=TeX-MML-AM_CHTML', function () {
