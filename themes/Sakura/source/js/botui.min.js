...
function bot_ui_ini(){var e=new BotUI("hello-amtoaer");e.message.add({delay:800,content:"Hi, there👋"}).then(function(){e.message.add({delay:1100,content:"这里是文文"}).then(function(){e.message.add({delay:1100,content:"一个可爱的蓝孩子~"}).then(function(){e.action.button({delay:1600,action:[{text:"然后呢？ 😃",value:"sure"},{text:"少废话！ 🙄",value:"skip"}]}).then(function(e){"sure"==e.value&&t(),"skip"==e.value&&n()})})})});var t=function(){e.message.add({delay:600,content:"😘"}).then(function(){a()})},n=function(){e.message.add({delay:600,content:"![...](https://view.moezx.cc/images/2018/05/06/a1c4cd0452528b572af37952489372b6.md.jpg)"})},a=function(){e.message.add({delay:1500,content:"目前就读于东北（哪所）大学 😆"}).then(function(){e.message.add({delay:2e3,content:"不知不觉已经成为了大三学生"}).then(function(){e.message.add({delay:1700,content:"打算本科毕业后就业，但现在还对未来一片迷茫..."}).then(function(){e.message.add({delay:2300,content:"目前在学Java刷leetcode，对golang/vue有一定了解"}).then(function(){e.action.button({delay:1100,action:[{text:"为什么叫amtoaer呢？ 🤔",value:"why-amtoaer"}]}).then(function(e){thirdpart()})})})})})};thirdpart=function(){e.message.add({delay:1e3,content:"其实没啥特别的含义啦。看到小伙伴们都有一个惯用的英文昵称，自己就随便打了一个，看着蛮顺眼也就用了 🤣"}).then(function(){e.action.button({delay:1500,action:[{text:"域名有什么特殊含义嘛？🤔",value:"why-domain"}]}).then(function(e){fourthpart()})})},fourthpart=function(){e.message.add({delay:1e3,content:"这个是有的，all (of these are) wen(wen') s work！"}).then(function(){e.message.add({delay:1600,content:"那么，仔细看看我的博客吧？ ^_^"})})}}